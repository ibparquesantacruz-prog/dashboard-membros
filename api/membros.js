    ...
    try {
        ...
        if (req.method === 'PUT') {
            await sql`
                UPDATE membros
                SET
                    Nm_Membro = ${sanitizedData.Nm_Membro}, Status = ${sanitizedData.Status}, Tem_Filhos = ${sanitizedData.Tem_Filhos}, Sexo = ${sanitizedData.Sexo},
                    Membro = ${sanitizedData.Membro}, Batizado = ${sanitizedData.Batizado}, Celular = ${sanitizedData.Celular}, Data_Nasc = ${sanitizedData.Data_Nasc},
                    CPF = ${sanitizedData.CPF}, Naturalidade = ${sanitizedData.Naturalidade}, Estado_Civil = ${sanitizedData.Estado_Civil}, Escolaridade = ${sanitizedData.Escolaridade},
                    Profissao = ${sanitizedData.Profissao}, Nm_Conjuge = ${sanitizedData.Nm_Conjuge}, Endereco = ${sanitizedData.Endereco}, Comp_Endereco = ${sanitizedData.Comp_Endereco},
                    Bairro = ${sanitizedData.Bairro}, Cidade = ${sanitizedData.Cidade}, CEP = ${sanitizedData.CEP}, Nm_Mae = ${sanitizedData.Nm_Mae}, Nm_Pai = ${sanitizedData.Nm_Pai}
